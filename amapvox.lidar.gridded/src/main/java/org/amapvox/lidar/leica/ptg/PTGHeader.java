...
/**
 * This class represents the header of a PTG binary scan file, a Leica gridded
 * point format. (see
 * <a href= "http://www.xdesy.de/freeware/PTG-DLL/PTG-1.0.pdf">
 * specification</a>)
 *
...
public class PTGHeader extends PointScanHeader {
    ...
    /**
     * Set texte attribute (to be ignored), this attribute may occur multiple
     * times, so it will be added to the current string and separated by ";"
     *
    ...
    /**
     * Set text attribute (to be ignored), this attribute may occur multiple
     * times, so it will be added to the current string and separated by ";"
     *
