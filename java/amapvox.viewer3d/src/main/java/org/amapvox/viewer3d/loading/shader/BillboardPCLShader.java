...
public class BillboardPCLShader extends Shader{
    ...
    public BillboardPCLShader(){
        ...
        setVertexShaderCode(loadCodeFromInputStream(getStream("/org/amapvox/viewer3d/shaders/instanceBillboardVertexShader.txt")));
        setFragmentShaderCode(loadCodeFromInputStream(getStream("/org/amapvox/viewer3d/shaders/InstanceFragmentShader.txt")));
        
        billboardCenter = new Uniform3F("billboardCenter");
        billboardSize = new Uniform1f("billboardSize");
    }
    
    public void setBillboardCenter(Vector3f center){
