...
public class BillboardShader extends Shader{
    ...
    public BillboardShader(){
        ...
        setVertexShaderCode(loadCodeFromInputStream(getStream("/org/amapvox/viewer3d/shaders/billboardVertexShader.txt")));
    ...
    public void setBillboardColor(Vector3f color){
