...
**Java**: For AMAPVox >= 2.0 Java is embedded with AMAPVox binaries. For
AMAPVox <= 1.10 the system requires Java 1.8 64-Bit with JavaFX. In practice either
\href{https://java.com/download/}{Java 1.8 64-Bit Oracle} or
\href{https://aws.amazon.com/fr/corretto/}{Java 1.8 64-Bit Corretto}.
